...
public class EditComponentView extends Composite implements
		EditComponentPresenter.Display {
	...
	public EditComponentView() {
		DecoratorPanel editComponentDecorator = new DecoratorPanel();
		editComponentDecorator.setWidth("18em");
		initWidget(editComponentDecorator);

		VerticalPanel editComponentPanel = new VerticalPanel();
		editComponentPanel.setWidth("100%");
		...
		lblName = new Label();
		lblMaterialIdentifier = new Label();
		lblDescription = new Label();
		initDetailsTable();
		editComponentPanel.add(detailsTable);
		...
		editComponentPanel.add(menuPanel);
		editComponentDecorator.add(editComponentPanel);
	}
