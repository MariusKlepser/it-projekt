...
public class EnderzeugnisOverview {
	...
	public Panel getView(){
		...
		// Start layout creation here
				HTML h1 = new HTML("<h1>Enderzeugnisse</h1>");
				panel.add(h1);
				...
				Label enderzeugnisname = new Label("Enderzeugnisname:");
				final TextBox enderzeugnisnametxt = new TextBox();	
				hPanel1.add(enderzeugnisname);
				hPanel1.add(enderzeugnisnametxt);
				hPanel1.setCellWidth(enderzeugnisname,"200px");
				...
				form.addSubmitHandler(new FormPanel.SubmitHandler() {
					public void onSubmit(SubmitEvent event) {
						...
						if (enderzeugnisnametxt.getText().length() == 0)
