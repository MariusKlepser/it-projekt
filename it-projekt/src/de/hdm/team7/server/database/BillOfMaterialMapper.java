...
public class BillOfMaterialMapper {
	 ...
	 * @return Ein Vektor mit BOM-Objekten, die sämtliche BOMs mit dem gesuchten
	 *         Namen repräsentieren. Bei evtl. Exceptions wird ein partiell
	...
	/**
	 * Einfügen eines <code>BOM</code>-Objekts in die Datenbank. Dabei wird auch
	 * der Primärschlüssel des übergebenen Objekts geprüft und ggf. berichtigt.
	 * 
	 * @param b
