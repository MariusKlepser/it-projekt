...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "de.hdm.team7.reportgenerator" because\n';
  ...
  $wnd.__gwt_activeModules['de.hdm.team7.reportgenerator'] = {
    'moduleName' : 'de.hdm.team7.reportgenerator',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/de.hdm.team7.reportgenerator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['de.hdm.team7.reportgenerator'].superdevmode = true;

  var expectedSuffix = '/de.hdm.team7.reportgenerator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + de.hdm.team7.reportgenerator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:de.hdm.team7.reportgenerator';
  var devModeSessionKey = '__gwtDevModeSession:de.hdm.team7.reportgenerator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/de.hdm.team7.reportgenerator/de.hdm.team7.reportgenerator.nocache.js';
  ...
  $wnd.__gwt_activeModules['de.hdm.team7.reportgenerator'].canRedirect = true;
  $wnd.__gwt_activeModules['de.hdm.team7.reportgenerator'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING de.hdm.team7.reportgenerator';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/de.hdm.team7.reportgenerator?user.agent=' + ua + '&_callback=' + callback;
