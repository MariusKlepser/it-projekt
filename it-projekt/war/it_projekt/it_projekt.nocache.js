...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "it_projekt" because\n';
  ...
  $wnd.__gwt_activeModules['it_projekt'] = {
    'moduleName' : 'it_projekt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/it_projekt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['it_projekt'].superdevmode = true;

  var expectedSuffix = '/it_projekt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + it_projekt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:it_projekt';
  var devModeSessionKey = '__gwtDevModeSession:it_projekt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':49182';
  var nocacheUrl = serverUrl + '/it_projekt/it_projekt.nocache.js';
  ...
  $wnd.__gwt_activeModules['it_projekt'].canRedirect = true;
  $wnd.__gwt_activeModules['it_projekt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/it_projekt?user.agent=' + ua + '&_callback=' + callback;
